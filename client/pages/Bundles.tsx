...
const bundles: Bundle[] = [
  {
    ...
    services: ["Level Boost (1-25)", "Basic Equipment Unlock", "Tutorial Completion"],
    originalPrice: 49.97,
  ...
  },
  {
    ...
    services: ["Level Boost (1-50)", "Planet Liberation x3", "All Difficulties Unlock", "Super Sample Farming"],
  ...
  },
  {
    ...
    services: ["Level Boost (1-50)", "Planet Liberation x5", "Galactic War Progress", "Medal & Credits Farming", "Super Sample Farming"],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Save more with our carefully crafted service packages designed for every type of Helldiver
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <Card className="text-center border border-border/50 hover:border-primary/30 transition-colors">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Significant savings compared to individual services</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border border-border/50 hover:border-primary/30 transition-colors">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Bundle orders get priority processing</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border border-border/50 hover:border-primary/30 transition-colors">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">All services in bundle fully completed</p>
            </CardContent>
          </Card>
        </div>
            ...
            >
              {bundle.badge && (
                <div className="absolute top-4 right-4 z-10">
                  <Badge className={bundle.popular 
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="flex items-center text-sm">
                    ...
                    <span className="font-medium text-primary ml-1">{bundle.duration}</span>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold mb-3 text-sm">Included Services:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold mb-3 text-sm">What You Get:</h4>
                    <div className="space-y-1">
